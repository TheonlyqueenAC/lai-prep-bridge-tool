...
class LargeScaleTestSuite:
    ...
    def generate_detailed_report(self, results):
        ...
        report.append(f"Average Success with Interventions:   {(results['avg_success_rate'] + results['avg_improvement']):.2%}")
        report.append(f"Average Improvement:                  +{results['avg_improvement']*100:.2f} percentage points")
        report.append(f"Relative Improvement:                 +{(results['avg_improvement']/results['avg_success_rate'])*100:.1f}%")
        report.append("")
        ...
        report.append("")
        report.append("With 1 million patients, estimates are statistically robust with very narrow confidence intervals.")
        report.append("")
        ...
        report.append(f"   - This represents a {(results['avg_improvement']/results['avg_success_rate'])*100:.1f}% relative improvement")
        report.append("")
